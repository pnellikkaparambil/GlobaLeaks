...
def db_create_submission(session, tid, request, user_session, client_using_tor, client_using_mobile, related_receiver_id=None):
    ...
    db_log(session, tid=tid, type='whistleblower_new_report', user_id=related_receiver_id, object_id=itip.id)

    return {'receipt': receipt}


@transact
def create_submission(session, tid, request, user_session, client_using_tor, client_using_mobile, related_receiver_id=None):
    return db_create_submission(session, tid, request, user_session, client_using_tor, client_using_mobile, related_receiver_id)
